...
class AssetData {
	...
	public static function initialize ():Void {
		...
		if (!initialized) {
			...
			className.set ("assets/Meteor.png", nme.NME_assets_meteor_png);
			type.set ("assets/Meteor.png", Reflect.field (AssetType, "image".toUpperCase ()));
			...
			className.set ("assets/stars.png", nme.NME_assets_stars_png);
			type.set ("assets/stars.png", Reflect.field (AssetType, "image".toUpperCase ()));
			className.set ("assets/stars_fore.png", nme.NME_assets_stars_fore_png);
			type.set ("assets/stars_fore.png", Reflect.field (AssetType, "image".toUpperCase ()));
			className.set ("assets/state_1.png", nme.NME_assets_state_1_png);
			type.set ("assets/state_1.png", Reflect.field (AssetType, "image".toUpperCase ()));
			className.set ("assets/state_2.png", nme.NME_assets_state_2_png);
			type.set ("assets/state_2.png", Reflect.field (AssetType, "image".toUpperCase ()));
			className.set ("assets/sun.png", nme.NME_assets_sun_png);
			type.set ("assets/sun.png", Reflect.field (AssetType, "image".toUpperCase ()));
...
class NME_assets_meteor_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
class NME_assets_player1_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
class NME_assets_stars_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
class NME_assets_stars_fore_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
class NME_assets_state_1_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
class NME_assets_state_2_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
class NME_assets_sun_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
