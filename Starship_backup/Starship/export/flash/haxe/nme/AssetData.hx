...
class AssetData {
	...
	public static function initialize ():Void {
		...
		if (!initialized) {
			...
			className.set ("assets/courier.ttf", nme.NME_assets_courier_ttf);
			type.set ("assets/courier.ttf", Reflect.field (AssetType, "font".toUpperCase ()));
			...
			className.set ("assets/World/CSV/mapCSV_Starship_Screen_1.csv", nme.NME_assets_world_csv_mapcsv_starship_screen_1_csv);
			type.set ("assets/World/CSV/mapCSV_Starship_Screen_1.csv", Reflect.field (AssetType, "text".toUpperCase ()));
			className.set ("assets/World/Grass_water_segment.png", nme.NME_assets_world_grass_water_segment_png);
			type.set ("assets/World/Grass_water_segment.png", Reflect.field (AssetType, "image".toUpperCase ()));
			className.set ("assets/World/Starship.dam", nme.NME_assets_world_starship_dam);
			type.set ("assets/World/Starship.dam", Reflect.field (AssetType, "text".toUpperCase ()));
			className.set ("assets/World/Starship.dam.bak", nme.NME_assets_world_starship_dam_bak);
			type.set ("assets/World/Starship.dam.bak", Reflect.field (AssetType, "text".toUpperCase ()));
			className.set ("assets/World/StarshipAtlas.png", nme.NME_assets_world_starshipatlas_png);
			type.set ("assets/World/StarshipAtlas.png", Reflect.field (AssetType, "image".toUpperCase ()));
			className.set ("assets/World/StarshipAtlas.psd", nme.NME_assets_world_starshipatlas_psd);
			type.set ("assets/World/StarshipAtlas.psd", Reflect.field (AssetType, "binary".toUpperCase ()));
...
class NME_assets_courier_ttf extends flash.text.Font { }
...
class NME_assets_world_csv_mapcsv_starship_screen_1_csv extends flash.utils.ByteArray { }
class NME_assets_world_grass_water_segment_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
class NME_assets_world_starship_dam extends flash.utils.ByteArray { }
class NME_assets_world_starship_dam_bak extends flash.utils.ByteArray { }
class NME_assets_world_starshipatlas_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
class NME_assets_world_starshipatlas_psd extends flash.utils.ByteArray { }
