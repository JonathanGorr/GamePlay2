...
class AssetData {
	...
	public static function initialize ():Void {
		...
		if (!initialized) {
			...
			className.set ("assets/World/Background.png", nme.NME_assets_world_background_png);
			type.set ("assets/World/Background.png", Reflect.field (AssetType, "image".toUpperCase ()));
			className.set ("assets/World/Clouds.png", nme.NME_assets_world_clouds_png);
			type.set ("assets/World/Clouds.png", Reflect.field (AssetType, "image".toUpperCase ()));
...
class NME_assets_world_background_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
class NME_assets_world_clouds_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
