...
if exportOnlyCSV == false then
	...
	for i,v in ipairs(maps) do
		...
		fileText = fileText..tab3.."layer"..layerName..".loadIsoMap( new CSV_"..layerName..", Img_"..layerName..", "..as3.tolua(layer.map.tileWidth)..","..as3.tolua(layer.map.tileHeight)..", "..as3.tolua(layer.map.tileOffsetX)..","..as3.tolua(layer.map.tileOffsetY)..", "..as3.tolua(layer.map.tileSpacingX)..","..as3.tolua(layer.map.tileSpacingY)..", "..as3.tolua(layer.map.tilesStartX)..","..as3.tolua(layer.map.tilesStartY)..", FlxTilemap.OFF, 0, "..as3.tolua(layer.map.drawIndex)..", "..as3.tolua(layer.map.collideIndex).." );\n"
